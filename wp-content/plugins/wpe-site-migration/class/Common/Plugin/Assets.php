    ...
    function load_assets()
    {
        ...
        wp_localize_script('wp-migrate-db-pro-script-v2',
            ...
            apply_filters('wpmdb_js_strings', array(
                ...
                'connection_info_local_url'             => __("It appears you've entered connection information for this site. Instead you need to provide connection information from the Settings tab of the remote site to which you are trying to connect.", 'wp-migrate-db'),
                ...
                'migration_cancelled_success'           => __('The migration has been canceled. Any temporary database tables or files created by the migration have been cleaned up.', 'wp-migrate-db'),
