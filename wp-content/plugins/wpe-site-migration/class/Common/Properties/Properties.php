...
class Properties
{
    ...
    public function __construct()
    {
        ...
        $this->invalid_content_verification_error = __('The connection information could not be authenticated because it is incorrect or expired. Copy new connection information from the Settings tab of the remote site and try again.', 'wp-migrate-db');
